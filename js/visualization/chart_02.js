...
{ 
  ...
  function createSeries1(field, name, stacked) {
    ...
    createSeries1("value1", "종합병원", true);
    createSeries1("value2", "병원", true);
    createSeries1("value3", "요양병원", true);
    createSeries1("value4", "의원", true);
    createSeries1("value5", "치과병의원", true);
    createSeries1("value6", "한방병원", true);
    createSeries1("value7", "한의원", true);
    createSeries1("value8", "보건소,보건진료소", true);
    createSeries1("value9", "약국", true);
    createSeries1("value10", "총계", false);
  ...
  // Add data
    ...
    createSeries2("value1", "의사", true);
    createSeries2("value2", "치과의사", true);
    createSeries2("value3", "한의사", true);
    createSeries2("value4", "약사", true);
    createSeries2("value5", "간호사", true);
    createSeries2("value6", "간호조무사", true);
    createSeries2("value7", "의료기사", true);
    createSeries2("value8", "보건의료정보관리사", true);
    createSeries2("value9", "총계", false);
  // Add cursor
  ...
  createSeries3("value1", "노인요양시설", true);
  createSeries3("value2", "노인요양공동생활가정", true);
  createSeries3("value3", "방문요양서비스", true);
  createSeries3("value4", "주야간보호시설", true);
  createSeries3("value5", "방문목욕서비스", true);
  createSeries3("value6", "재가지원서비스", true);
  ...
  createSeries4("value1", "거주시설", true);
  createSeries4("value2", "공동생활가정", true);
  createSeries4("value3", "장애인복지관", true);
  createSeries4("value4", "주간보호시설", true);
  createSeries4("value5", "장애인체육시설", true);
  createSeries4("value6", "수어릉역센터", true);
  createSeries4("value7", "생활이동지원센터", true);
  createSeries4("value8", "점자도서관", true);
  createSeries4("value9", "재활치료설계", true);
  createSeries4("value10", "총계", false);
 ...
 chart_2_5.cursor.behavior = 'none';
  ...
  createSeries6("value1", "평화사회복지관");
  createSeries6("value2", "전주종합복지관");
  createSeries6("value3", "전북종합복지관");
  createSeries6("value4", "선너머복지관");
  createSeries6("value5", "학산종합복지관");
  ...
  if(val == 'chart_box_02_07')
{
  ...
  //  
    ...
    createSeries7("value1", "특례노령연금", true);
    createSeries7("value2", "노령연금(20년이상)", true);
    createSeries7("value3", "노령연금(10년~20년미만)", true);
    createSeries7("value4", "조기노령연금", true);
    createSeries7("value5", "분할노령연금", true);
    createSeries7("value6", "장애연금", true);
    createSeries7("value7", "유족연금", true);
    createSeries7("value8", "장애일시금", true);
    createSeries7("value9", "반환일시금", true);
    createSeries7("value10", "사망일시금", true);
    createSeries7("value11", "총계", false);
  ...
  if(val == 'chart_box_02_08')
{
  ...
  //  
    ...
    createSeries8("value1", "특례노령연금", true);
    createSeries8("value2", "노령연금(20년이상)", true);
    createSeries8("value3", "노령연금(10년~20년미만)", true);
    createSeries8("value4", "조기노령연금", true);
    createSeries8("value5", "분할노령연금", true);
    createSeries8("value6", "장애연금", true);
    createSeries8("value7", "유족연금", true);
    createSeries8("value8", "장애일시금", true);
    createSeries8("value9", "반환일시금", true);
    createSeries8("value10", "사망일시금", true);
    createSeries8("value11", "총계", false);
